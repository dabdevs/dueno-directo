...
class SendRegistrationMessage extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Your default password is: ' . $notifiable->password . '. You can change it later once you login to your dashboard.')
            ->line('Best regards,')
